$(function () {
    $("#scrap").click(function () {
        chrome.storage.sync.remove("process"), chrome.storage.sync.get("userType", function (e) {
            if ((void 0 !== e.userType) || (1 == 1))
                if (("demo" != e.userType) || (1 == 1)) {
                    let e = $("#keyword").val(),
                        a = $("#location").val(),
                        r = $("#url").val();
        ...
        if (void 0 !== e.userType || (1==1))
            ...
            } else $(".scrapSection").append('<div class="alert alert-primary alert-dismissible fade show" role="alert" style="position: fixed; left: 0; top: 0; right: 0; height: inherit; border-radius: 0; padding-bottom: 18px;"><strong>Demo Ufghfghser, </strong> Any Query Call +91 8052808784<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>')
    })
});